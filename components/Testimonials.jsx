...
// Section 08 — In Their Words
const testimonials = [
  {
    color: '#2563eb',
    quote:
      "We had three different freelancers running our Zoho before. None of them documented anything. ZoFlowX rebuilt the whole stack, handed us a playbook, and now my team actually knows where each report lives.",
    name: 'Priya R.',
    role: 'Head of Ops · D2C brand, Bangalore',
    initial: 'PR',
  },
  {
    color: '#dc2626',
    quote:
      "I was sceptical about a managed service after our last partner ghosted us. ZoFlowX is the opposite — they reply same day, every change is logged, and our CFO can finally pull a clean P&L without IT in the loop.",
    name: 'Daniel A.',
    role: 'CFO · Manufacturing exporter, NJ',
    initial: 'DA',
  },
  {
    color: '#f59e0b',
    quote:
      "The audit alone was worth the call. They found four broken workflows we didn't even know existed and showed us exactly how much time the team was losing every week. We signed the contract the same day.",
    name: 'Anjali M.',
    role: 'Founder · SaaS startup, Chennai',
    initial: 'AM',
  },
]
...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" style={{ background: '#fafaf7', position: 'relative', overflow: 'hidden' }} ref={ref}>
      ...
      <div className="container position-relative">
        <div className="text-center mb-5 fade-up" style={{ maxWidth: 780, margin: '0 auto 60px' }}>
          ...
          <h2 className="section-title">
            Straight from the people <span className="grad-red-yellow">we work with</span>
          </h2>
          <p className="section-sub mx-auto">
            We pick projects we know we can win. Here&apos;s what the wins look like in our clients&apos; own words.
          </p>
        </div>
            ...
            <div key={t.name} className="col-md-6 col-lg-4 fade-up" style={{ transitionDelay: `${i * 0.08}s` }}>
              <div className="t-card" style={{
                ...
                onMouseEnter={e => {
                  ...
                  el.style.boxShadow = `0 28px 60px ${t.color}24`
              ...
              >
                ...
                <p style={{
                  fontSize: '0.95rem', color: '#0b1220', lineHeight: 1.75,
