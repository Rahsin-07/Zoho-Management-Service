...
const articles = [
  {
    ...
    excerpt:
      "The questions we ask, the screens we open, and the four red flags we look for before we even quote you a number.",
...
export default function Resources() {
  ...
  return (
    <section id="journal" style={{ background: '#fafaf7', position: 'relative' }} ref={ref}>
        ...
        <div className="row align-items-end mb-5 fade-up">
          ...
          <div className="col-lg-4 text-lg-end mt-3 mt-lg-0 d-none d-lg-block">
            <a href="#" className="link-reveal">
              Read the journal <i className="bi bi-arrow-right" />
            </a>
          </div>
        </div>
              ...
              <a href="#" style={{ textDecoration: 'none', display: 'block', height: '100%' }}>
                ...
                >
                  ...
                  <div style={{
                    ...
                    <div className="art-cover" aria-hidden style={{
                      ...
                      <div style={{
                        ...
                        background: '#fff', boxShadow: `0 16px 40px ${a.color}30`,
                        display: 'flex', alignItems: 'center', justifyContent: 'center',
                  ...
                  <div style={{ padding: '24px 26px 28px', display: 'flex', flexDirection: 'column', flex: 1 }}>
                    ...
                    <p style={{
                      fontSize: '0.88rem', color: '#64748b', lineHeight: 1.68,
