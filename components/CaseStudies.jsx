...
const cases = [
  {
    ...
    metrics: [
      ...
      { label: 'Lead-to-quote time',     value: '3 days → 6 hrs' },
  ...
  },
  {
    ...
    summary:
      'Moved 1,500+ customers, 500+ vendors, custom-numbered records, and a full GST invoice template into Zoho Books. Set up rules for de-duplicated phone numbers, PIN code fields, and a Tally-style branded invoice format.',
    metrics: [
      { label: 'Customer records migrated', value: '1,522' },
      { label: 'Vendor records migrated',   value: '506' },
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: 'Sprint plan delivered', value: '6 wks' },
    ],
...
export default function CaseStudies() {
  ...
  return (
    <section id="case-studies" style={{ background: '#fff', position: 'relative' }} ref={ref}>
            ...
            <div key={c.company} className="col-lg-4 fade-up" style={{ transitionDelay: `${i * 0.1}s` }}>
              ...
              >
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 22 }}>
                  ...
                  <div>
                    <div style={{
                      fontSize: '0.7rem', fontWeight: 800, letterSpacing: 1.6,
                ...
                <p style={{
                  fontSize: '0.9rem', color: '#64748b', lineHeight: 1.72,
