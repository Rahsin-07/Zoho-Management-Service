      ...
      <div className="container">
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 16 }}>
          ...
          <div className="d-none d-lg-flex align-items-center" style={{ gap: 10, flexShrink: 0 }}>
            <a href="#consultation" className="btn-gradient" style={{ padding: '0.58rem 1.3rem', fontSize: '0.85rem' }}>
        ...
        {menuOpen && (
          <div style={{ padding: '16px 0 8px', borderTop: '1px solid #e8e3dc', marginTop: 12 }}>
            ...
            <div style={{ marginTop: 14, display: 'flex', gap: 10 }}>
              <a href="#consultation" onClick={() => setMenuOpen(false)} className="btn-gradient" style={{ padding: '0.6rem 1.2rem', fontSize: '0.85rem' }}>Book My Free Audit</a>
              <a href="https://wa.me/918190009222" target="_blank" rel="noreferrer"
